Цель проекта: обучить нейронную сеть, классифицирующую электронные письма в правильную папку на базе датасета писем компании Enron (библиотеки re, numpy, pandas, pyplot, sklearn, keras).
